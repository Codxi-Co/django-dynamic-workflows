...
class DefaultActionsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.department2 = Department.objects.create(name='Second Department', company=self.company)
    ...
    def test_user_with_started_by_different_from_created_by(self):
        ...
        with patch('django_workflow_engine.default_actions._send_email') as mock_send_email:
            mock_send_email.return_value = True
            ...
            self.assertIn(starter_user.email, recipients)  # Starter (from attachment.started_by)
