...
class WorkflowLogger:
    ...
    def log_workflow_created(self, workflow_id: int, user_id: int, name_en: str, name_ar: str):
    ...
    def log_workflow_attached(self, workflow_id: int, object_type: str, object_id: str, user_id: int = None):
    ...
    def log_workflow_started(self, workflow_id: int, object_type: str, object_id: str, user_id: int = None):
        """Log workflow start."""
        self.log_action(
            "workflow_started",
            workflow_id=workflow_id,
    ...
    def log_stage_moved(self, workflow_id: int, from_stage: str, to_stage: str, object_id: str, user_id: int = None):
    ...
    def log_workflow_completed(self, workflow_id: int, object_id: str, user_id: int = None, duration_seconds: float = None):
    ...
    def log_workflow_rejected(self, workflow_id: int, stage: str, reason: str, object_id: str, user_id: int = None):
    ...
    def log_approval_action(self, action: str, workflow_id: int, stage: str, user_id: int = None, **kwargs):
...
def log_model_operation(model_name: str, operation: str, object_id: str = None, user_id: int = None, **kwargs):
...
def log_serializer_validation(serializer_name: str, is_valid: bool, errors: Dict = None, user_id: int = None):
...
def log_api_request(endpoint: str, method: str, user_id: int = None, response_status: int = None, duration_ms: float = None):
