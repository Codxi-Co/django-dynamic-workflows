...
class WorkflowServicesTest(TestCase):
    ...
    def test_start_workflow_for_object(self, mock_build_steps, mock_start_flow):
        ...
        self.assertEqual(updated_attachment.status, WorkflowAttachmentStatus.IN_PROGRESS)
    ...
    def test_reject_workflow_stage(self):
        ...
        self.assertEqual(updated_attachment.metadata['rejection_reason'], "Not approved")
