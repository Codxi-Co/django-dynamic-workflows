...
class WorkFlowAdmin(admin.ModelAdmin):
    ...
    list_display = ['name_en', 'name_ar', 'company', 'status', 'created_at', 'is_active']
    ...
    fieldsets = (
        (None, {
            'fields': ('company', 'name_en', 'name_ar', 'status', 'description')
        }),
        ('Audit', {
...
class PipelineAdmin(admin.ModelAdmin):
    ...
    list_display = ['name_en', 'name_ar', 'workflow', 'department', 'company', 'order', 'created_at']
    ...
    fieldsets = (
        (None, {
            'fields': ('workflow', 'company', 'name_en', 'name_ar', 'department', 'order')
        }),
        ('Audit', {
            'fields': ('created_by', 'modified_by', 'created_at', 'updated_at'),
            'classes': ('collapse',)
...
class StageAdmin(admin.ModelAdmin):
    ...
    list_display = ['name_en', 'name_ar', 'pipeline', 'is_active', 'order', 'created_at']
    ...
    fieldsets = (
        (None, {
            'fields': ('pipeline', 'company', 'name_en', 'name_ar', 'order', 'is_active')
        }),
        ('Configuration', {
            'fields': ('form_info', 'stage_info'),
            'classes': ('collapse',)
        }),
        ('Audit', {
            'fields': ('created_by', 'modified_by', 'created_at', 'updated_at'),
...
class WorkflowAttachmentAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'id', 'get_target_object', 'workflow', 'status',
        'current_stage', 'progress_percentage', 'started_at'
    ]
    ...
    fieldsets = (
        (None, {
            'fields': ('workflow', 'content_type', 'object_id', 'status')
        }),
        ('Progress', {
...
class WorkflowConfigurationAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'get_model_name', 'is_enabled', 'auto_start_workflow',
        'default_workflow', 'created_at'
    ]
    ...
    fieldsets = (
        (None, {
            'fields': ('content_type', 'is_enabled', 'auto_start_workflow', 'default_workflow')
        }),
        ('Field Mappings', {
            'fields': ('status_field', 'stage_field')
        }),
        ('Hooks', {
...
class WorkflowActionAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'action_type', 'get_scope', 'function_path', 'is_active', 'order', 'created_at'
    ]
    list_filter = ['action_type', 'is_active', 'workflow', 'pipeline', 'stage']
    search_fields = ['function_path', 'workflow__name_en', 'pipeline__name_en', 'stage__name_en']
    readonly_fields = ['created_at', 'updated_at', 'scope_level']

    fieldsets = (
        (None, {
            'fields': ('action_type', 'function_path', 'is_active', 'order')
        }),
